 ...
 * Owner-only: admins can't promote/demote (avoids privilege escalation).
 */
export async function PATCH(
  ...
  if (client.current_user_role !== 'owner') {
  ...
  const result = await callInternal(ctx, `/internal/team/members/${id}`, {
    method: 'PATCH',
    headers: {
